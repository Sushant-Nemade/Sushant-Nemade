...
<picture>
  ...
  <img src="options/option_3/assets/capability-deck.svg" width="900" alt="Dark capability command deck covering Python, SQL, AI and machine learning, GenAI, analytics, automation and delivery">
</picture>
...
<picture>
  ...
  <img src="options/option_3/assets/system-architecture.svg" width="900" alt="Animated pseudo-3D architecture showing Discover, Evaluate, Build, Validate and Adopt under Responsible AI, GDPR and human oversight">
</picture>
...
<sub>Systems Console is generated locally with Python. It uses no remote image service, font, analytics tracker, client-side JavaScript or profile-statistics server. Previous layouts remain available in <a href="README.option-1.md">Option 1</a> and <a href="README.option-2.md">Option 2</a>.</sub>
