...
1. Original animated SN Signal Core and terminal identity
...
- All visual assets are generated locally from `config/profile.json`; the SN Signal Core is constructed directly from SVG geometry and needs no source image.
